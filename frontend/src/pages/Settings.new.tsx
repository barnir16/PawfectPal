...
const Settings = () => {
  ...
  const handleNotificationsSave = async (updatedNotifications: NotificationSettings) => {
    // In a real app, you would make an API call here
  ...
  const handleAppearanceSave = async (updatedAppearance: { theme: ThemePreference; language: Language }) => {
    // In a real app, you would make an API call here
        ...
        <Box flexGrow={1}>
          ...
          <Box sx={{ display: activeTab === 4 ? 'block' : 'none', mt: 2 }}>
            ...
            <Typography paragraph>
              If you need assistance, please contact our support team at support@pawfectpal.com
