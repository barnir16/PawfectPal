export const en = {
  ...
  pets: {
    ...
    birthMonthHelp: 'Pick a month to make the age more accurate over time',
  ...
  vaccines: {
    ...
    vaccineTrackerNotice: 'Suggestions are guidance only and should be confirmed against your veterinarian, your pet records, and local requirements.',
  ...
  dashboard: {
    ...
    youHave: 'You have',
    urgentItems: 'items that need attention today.',
    allCaughtUp: 'Your pets are all caught up. Great job! 🐾',
    addFirstPet: 'Welcome to PawfectPal — add your first pet to get started.',
  ...
  settings: {
    ...
    primaryVetNamePlaceholder: 'Dr. Smith',
    emergencyVetNamePlaceholder: '24/7 Emergency Hospital',
    petSitterNamePlaceholder: 'Jane Doe',
  ...
  chat: {
    ...
    quickReplies: {
      provider: {
        greeting: "Hi! I'm interested in providing this service for you.",
        availability: "I'm available for this service. When would be a good time to discuss the details?",
        experience: "I have extensive experience with this type of service. Would you like to schedule a consultation?",
        location: "I'm located nearby. Would you like to meet in person to discuss the service?",
        photos: "Could you share some photos of your pet? This will help me provide the best care.",
        instructions: "Please share any special instructions or requirements for your pet's care.",
      },
      client: {
        greeting: "Hi! I'm interested in your service request.",
        availability: "I'm available for this service. When would you like to meet?",
        location: "Could you share the exact location?",
      },
    },
    ...
    noConversationsDescription: 'Start a conversation by creating a service request',
    ...
    requestPetPhotos: 'Request Pet Photos',
    ...
    clientLabel: 'Client',
    detailedPetInfo: 'Detailed Pet Information',
    sharedFiles: 'Shared files',
    locationSharedMsg: 'Location shared',
  ...
  services: {
    title: 'Services',
    manageBookings: 'My Bookings',
    manageBookingsSubtitle: 'Track service bookings you already opened with providers, including upcoming visits and completed care.',
    ...
    findProvidersSubtitle: 'Browse provider profiles, compare specialties, and start a service request with the right person.',
    filterProvidersByType: 'Filter Providers by Service Type',
    providerRequestInbox: 'Provider Request Inbox',
    providerRequestInboxSubtitle: 'Provider-side view of owner requests and open opportunities that still need a response.',
    clientRequests: 'Client Requests',
    myPostedRequests: 'My Posted Requests',
    myPostedRequestsSubtitle: 'Requests you published for providers to review, message, and respond to.',
    description: 'Description',
    serviceType: 'Service Type',
    ...
    directRequestDescription: 'Send request directly to a specific provider',
    publicPost: 'Public Post',
    publicPostDescription: 'Post publicly for all providers to see and respond',
    maxProviders: 'Max Providers',
    maxProvidersHelp: 'Maximum number of providers who can respond',
    responseDeadline: 'Response Deadline',
    responseDeadlineHelp: 'When should providers stop responding?',
    autoAssign: 'Auto-Assign Best Provider',
    autoAssignDescription: 'Automatically assign the best provider based on ratings and experience',
    ...
    serviceTypePlaceholder: 'e.g., Dog Walking, Pet Sitting',
  ...
  marketplace: {
    ...
    createPostSubtitle: 'Share your service needs with all providers',
    myPosts: 'My Posts',
    allPosts: 'All Posts',
    noPosts: 'No posts found',
    createNewPost: 'Create New Post',
    postTitle: 'Post Title',
    titlePlaceholder: 'e.g., Need dog walking for vacation',
    description: 'Description',
    ...
    draftWithAiHint: 'Pick a service type and at least one pet first',
    aiDraftApplied: 'AI draft applied — feel free to edit it.',
    aiDraftFallbackApplied: 'AI was unavailable, so we filled in a quick starter draft instead.',
    aiDraftFailed: 'Could not generate a draft. Please try again.',
    budget: 'Budget',
    ...
    languagePlaceholder: 'English, Hebrew, etc.',
    ...
    subtitle: 'Post what you need so providers can discover and respond to it',
    urgentOnly: 'Urgent Only',
    noPostsFound: 'No posts found',
    noPostsDescription: 'Try adjusting your filters or create a new post',
    noMyPosts: 'You haven\'t created any posts yet',
    createFirstPost: 'Create your first marketplace post to get started',
    ...
    postSaved: 'Marketplace post saved successfully',
    postDeleted: 'Marketplace post deleted',
    contactRecorded: 'Response recorded. Direct marketplace messaging is still being finalized.',
    alreadyResponded: 'You already responded to this post.',
    cannotRespondOwnPost: "You can't respond to your own post.",
    respondFailed: 'Could not send your response. Please try again.',
  },
  notifications: {
