export const en = {
  ...
  pets: {
    ...
    veterinarianPlaceholder: 'Veterinarian name (optional)',
    clinicPlaceholder: 'Clinic name (optional)',
    vaccineNotesPlaceholder: 'Additional notes about the vaccine (optional)',
    vaccineTypePlaceholder: 'e.g., Core, Non-core, Required',
    veterinarianNamePlaceholder: 'Dr. Smith',
    clinicNamePlaceholder: 'Animal Hospital',
    vaccineNotesPlaceholder2: 'Any additional notes about the vaccination...',
  ...
  vaccines: {
    ...
    veterinarian: 'Veterinarian',
    veterinarianPlaceholder: 'Enter veterinarian name',
    clinic: 'Clinic',
