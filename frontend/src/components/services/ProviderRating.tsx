              ...
              {reviews.map((review) => (
                <Box key={review.id} sx={{ mb: 2 }}>
                  <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                    ...
                    <Chip
                      label={
                        t(`services.${review.service_type}`) ||
                        review.service_type
                      }
                  ...
                  <Typography variant="caption" color="text.secondary">
                    {t("services.by") || "by"} {review.reviewer_name} •{" "}
        ...
        <DialogContent>
          <Box sx={{ pt: 1 }}>
            ...
            <TextField
              ...
              placeholder={
                t("services.serviceTypePlaceholder") ||
                "e.g., Dog Walking, Pet Sitting"
              }
            />
          </Box>
        </DialogContent>
        <DialogActions>
          ...
          >
            {loading ? (
              ...
              t("services.submitReview") || "Submit Review"
            )}
          </Button>
        </DialogActions>
      </Dialog>
