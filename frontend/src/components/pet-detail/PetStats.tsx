...
import { Cake as CakeIcon, Scale as ScaleIcon, LocalHospital as HospitalIcon, Event as EventIcon } from '@mui/icons-material';
...
export const PetStats = ({ pet }: PetStatsProps) => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: lastVetVisit ? format(new Date(lastVetVisit), 'MMM d, yyyy') : 'Never',
      description: lastVetVisit ? 'Health check-up' : 'No records found',
    },
    {
      icon: <EventIcon color="primary" />,
      label: 'Next Vaccination',
      value: nextVaccination ? format(new Date(nextVaccination), 'MMM d, yyyy') : 'Not scheduled',
