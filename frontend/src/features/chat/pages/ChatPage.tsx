          ...
          <Collapse in={isServiceInfoExpanded}>
            <Box sx={{ width: '100%' }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'column' }, gap: 1 }}>
                ...
                <Box sx={{ flex: 1 }}>
                  <Paper elevation={1} sx={{ p: 1.5, borderRadius: 2, height: 'auto' }}>
                    ...
                    <List dense>
                      <ListItem>
                        ...
                        <ListItemText 
                          ...
                          secondary={serviceRequest.service_type}
                        />
                      </ListItem>
                  ...
                  <Paper elevation={1} sx={{ p: 2, borderRadius: 2, height: '100%' }}>
                    ...
                    {serviceRequest.assigned_provider && (
                      <Box sx={{ mb: 3 }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, p: 1, backgroundColor: 'action.hover', borderRadius: 1 }}>
                          <Avatar sx={{ width: 40, height: 40 }}>
                            {serviceRequest.assigned_provider.username?.charAt(0).toUpperCase()}
                          </Avatar>
                          <Box>
                            <Typography variant="body1" fontWeight={500}>
                              {serviceRequest.assigned_provider.full_name || serviceRequest.assigned_provider.username}
                            </Typography>
                            <Typography variant="body2" color="text.secondary">
                    ...
                    {pets && pets.length > 0 && (
                      <Box>
                        ...
                        <Stack spacing={1.5}>
                          {pets.map((pet) => (
                            <Paper key={pet.id} elevation={0} sx={{ p: 1.5, border: 1, borderColor: 'divider', borderRadius: 2 }}>
