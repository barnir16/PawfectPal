...
class MedicalRecordORM(Base):
    ...
    record_type: Mapped[str] = mapped_column(String, nullable=False)  # vaccination, checkup, surgery, etc.
    ...
    # Relationships
    pet: Mapped["PetORM"] = relationship("PetORM", back_populates="medical_records", lazy="selectin")
